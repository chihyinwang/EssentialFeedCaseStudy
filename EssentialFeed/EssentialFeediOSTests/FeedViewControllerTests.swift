...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadFeedActions_requestsFeedFromLoader() {
        ...
        XCTAssertEqual(loader.loadCallCount, 2, "Expected another loading request after user initiates a load")
        
        sut.simulateUserInitiatedFeedReload()
        XCTAssertEqual(loader.loadCallCount, 3, "Expected a third loading request after user initiates another load")
    }
    ...
    class LoaderSpy: FeedLoader {
        ...
        func completeFeedLoadingWithError(at index: Int) {
            completions[index](.failure(NSError(domain: "any-error", code: 0)))
        }
    }
}
